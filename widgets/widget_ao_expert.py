...
ExpertWidgetTemplate, ExpertClassTemplate = loadUiType(
        os.environ["SHESHA_ROOT"] + "/widgets/widget_ao_expert.ui")  # type: type, type
...
class WidgetAOExpert(ExpertClassTemplate):
    ...
    def __init__(self) -> None:
        ...
        self.uiExpert.wao_selectRtcMatrix.currentIndexChanged.connect(self.displayRtcMatrix)
    ...
    def updateAmpliCompGUI(self) -> None:
        ...
        self.uiExpert.wao_pyr_ampl_arcsec.setValue(self.uiExpert.wao_pyr_ampl.value() * diffract)
    ...
    def updateDmPanel(self) -> None:
        ...
        self.uiExpert.wao_dmActuPushArcSecNumWFS.addItems([str(i) for i in range(len(self.sim.config.p_dms))])
    ...
    def updateWfsPanel(self) -> None:
        ...
        if (self.sim.config.p_wfss[nwfs].gsalt > 0):
            ...
            self.uiExpert.wao_wfsLGSpower.setValue(self.sim.config.p_wfss[nwfs].laserpower)
    ...
    def updateAtmosPanel(self) -> None:
        ...
        self.uiExpert.wao_windDirection.setValue(self.sim.config.p_atmos.winddir[nscreen])
    ...
    def updateRtcPanel(self) -> None:
        ...
        self.uiExpert.wao_centroThresh.setValue(self.sim.config.p_centroiders[ncentro].thresh)
    ...
    def setRtcParams(self) -> None:
        ...
        self.sim.config.p_centroiders[ncentro].set_width(self.uiExpert.wao_centroWidth.value())
        ...
        self.sim.config.p_controllers[0].set_maxcond(self.uiExpert.wao_controlCond.value())
        self.sim.config.p_controllers[0].set_delay(self.uiExpert.wao_controlDelay.value())
    ...
    def setWfsParams(self) -> None:
        ...
        self.sim.config.p_wfss[nwfs].set_optthroughput(self.uiExpert.wao_wfsThrough.value())
        ...
        if (self.uiExpert.wao_wfsIsLGS.isChecked()):
            ...
            self.sim.config.p_wfss[nwfs].set_laserpower(self.uiExpert.wao_wfsLGSpower.value())
            self.sim.config.p_wfss[nwfs].set_lgsreturnperwatt(
                    self.uiExpert.wao_wfsReturnPerWatt.value())
            self.sim.config.p_wfss[nwfs].set_beamsize(self.uiExpert.wao_wfsBeamSize.value())
    ...
    def setDmParams(self) -> None:
        ...
        self.sim.config.p_dms[ndm].set_unitpervolt(self.uiExpert.wao_dmUnitPerVolt.value())
    ...
    def displayRtcMatrix(self) -> None:
        ...
        if (self.sim.rtc):
            ...
            if (data is not None):
                ...
                if (len(data.shape) == 2):
                    self.uiExpert.wao_rtcWindow.canvas.axes.matshow(data, aspect="auto",
                                                              origin="lower",
                                                              cmap="gray")
                    ...
                    if (type_matrix == "Eigenvalues"):
                        ...
                        self.uiExpert.wao_rtcWindow.canvas.axes.grid(which='minor', alpha=0.2)
                        self.uiExpert.wao_rtcWindow.canvas.axes.grid(which='major', alpha=0.5)
