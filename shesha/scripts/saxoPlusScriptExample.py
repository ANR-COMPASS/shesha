...
<wao.wao1.supervisor> is the First stage supervisor
<wao.wao2.supervisor> is the Second stage supervisor
...
for i in trange(nbiters): saxoplusmanager.next(); # exposure...
