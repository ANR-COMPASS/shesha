...
p_loop.set_ittime(1./1380.)       # loop at 1380 Hz
#p_loop.set_ittime(1./600.)        # loop at 600 Hz
#p_loop.set_ittime(1./300.)        # loop at 300 Hz
...
p_dm0.set_file_influ_fits(os.path.join(os.path.dirname(__file__),"SAXO_HODM.fits"))
...
p_controller0.set_type("ls")    # ls (classic easy simple) or generic
p_controller0.set_nwfs([0])     # /!\
p_controller0.set_ndm([0, 1])   # /!\
p_controller0.set_maxcond(1500) #     determines the nb of modes to be filtered
p_controller0.set_delay(1.15)   # /!\ total delay set to 2.15
